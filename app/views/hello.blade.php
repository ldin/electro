...
<head>
    ...
    <title>Электромонтаж в загородных домах Москвы и Московской области</title>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-sm-1-5 col-xs-12">
						...
						<div class="ch-txt">
							<p>Сделайте заказ, позвонив по телефону <br><a href="#">8 909 624 64 04</a> или <a href="#">оставьте заявку на нашем сайте</a></p>
						</div>
					</div>
					<div class="col-sm-1-5 col-xs-12">
						<div class="ch-img">
